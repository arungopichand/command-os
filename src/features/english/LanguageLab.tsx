...
// --- Static High-Yield Lexicon ---
const LEXICON_POOL = [
  { word: 'Pragmatic', phonetic: '/præɡˈmæt.ɪk/', meaning: 'Dealing with things sensibly and realistically in a way that is based on practical rather than theoretical considerations.', sentence: 'We need a pragmatic approach to solve the architectural bottlenecks.' },
  { word: 'Resilient', phonetic: '/rɪˈzɪl.i.ənt/', meaning: 'Able to withstand or recover quickly from difficult conditions.', sentence: 'The system architecture is highly resilient to external disruptions.' },
  { word: 'Paradigm', phonetic: '/ˈpær.ə.daɪm/', meaning: 'A typical example or pattern of something; a model.', sentence: 'This refactor represents a complete paradigm shift in our operational strategy.' },
  { word: 'Ubiquitous', phonetic: '/juːˈbɪk.wɪ.təs/', meaning: 'Present, appearing, or found everywhere.', sentence: 'Standardization has become ubiquitous across all tactical modules.' },
];

// --- Sub-Component: Word of the Day ---
...
// --- Sub-Component: Sentence of the Day ---
function SentenceOfTheDay() {
  const item = LEXICON_POOL[0]; // Simplified for demo
  return (
...
// --- Main Feature Component: Language Lab ---
