...
export function Project360() {
  const [goals, setGoals] = useLocalStorage<{id: string, text: string, completed: boolean}[]>('apex_360_goals', 
    BASE_GOAL_TEXTS.map(g => ({ id: generateUUID(), text: g, completed: false }))
  );
